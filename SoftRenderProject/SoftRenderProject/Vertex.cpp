...
//#define LERP(a) (pTrangle->v[0].a * lamda1 + pTrangle->v[1].a * lamda2 + pTrangle->v[2].a * lamda3) * z;
	...
	normal.x = BARCENTRIC_LERP(v1.normal.x, v2.normal.x, v3.normal.x, p1, p2, p3);
	normal.y = BARCENTRIC_LERP(v1.normal.y, v2.normal.y, v3.normal.y, p1, p2, p3);
	normal.z = BARCENTRIC_LERP(v1.normal.z, v2.normal.z, v3.normal.z, p1, p2, p3);

	worldPos.x = BARCENTRIC_LERP(v1.worldPos.x, v2.worldPos.x, v3.worldPos.x, p1, p2, p3);
	worldPos.y = BARCENTRIC_LERP(v1.worldPos.y, v2.worldPos.y, v3.worldPos.y, p1, p2, p3);
	worldPos.z = BARCENTRIC_LERP(v1.worldPos.z, v2.worldPos.z, v3.worldPos.z, p1, p2, p3);

	worldNormal.x = BARCENTRIC_LERP(v1.worldNormal.x, v2.worldNormal.x, v3.worldNormal.x, p1, p2, p3);
	worldNormal.y = BARCENTRIC_LERP(v1.worldNormal.y, v2.worldNormal.y, v3.worldNormal.y, p1, p2, p3);
	worldNormal.z = BARCENTRIC_LERP(v1.worldNormal.z, v2.worldNormal.z, v3.worldNormal.z, p1, p2, p3);
